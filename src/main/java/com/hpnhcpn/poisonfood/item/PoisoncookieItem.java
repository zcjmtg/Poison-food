...
public class PoisoncookieItem extends PoisonFoodModElements.ModElement {
	@ObjectHolder("poison_food:poisoncookie")
	public static final Item block = null;

	public PoisoncookieItem(PoisonFoodModElements instance) {
		super(instance, 7);
	}
