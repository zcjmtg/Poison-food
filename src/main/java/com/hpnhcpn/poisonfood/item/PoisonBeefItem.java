...
public class PoisonBeefItem extends PoisonFoodModElements.ModElement {
	@ObjectHolder("poison_food:poison_beef")
	public static final Item block = null;

	public PoisonBeefItem(PoisonFoodModElements instance) {
		super(instance, 15);
	}
