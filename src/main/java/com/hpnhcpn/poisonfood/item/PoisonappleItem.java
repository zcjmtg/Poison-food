...
public class PoisonappleItem extends PoisonFoodModElements.ModElement {
	@ObjectHolder("poison_food:poisonapple")
	public static final Item block = null;

	public PoisonappleItem(PoisonFoodModElements instance) {
		super(instance, 8);
	}
