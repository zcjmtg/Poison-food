...
public class PoisonchorusfruitItem extends PoisonFoodModElements.ModElement {
	@ObjectHolder("poison_food:poisonchorusfruit")
	public static final Item block = null;

	public PoisonchorusfruitItem(PoisonFoodModElements instance) {
		super(instance, 16);
	}
		...
		public ItemCustom() {
			super(new Item.Properties().group(PosionfoodItemGroup.tab).maxStackSize(64).rarity(Rarity.COMMON)
					.food((new Food.Builder()).hunger(2).saturation(1f)
							...
							.build()));
			setRegistryName("poisonchorusfruit");
		}
