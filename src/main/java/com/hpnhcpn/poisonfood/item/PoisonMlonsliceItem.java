...
public class PoisonMlonsliceItem extends PoisonFoodModElements.ModElement {
	@ObjectHolder("poison_food:poison_mlonslice")
	public static final Item block = null;

	public PoisonMlonsliceItem(PoisonFoodModElements instance) {
		super(instance, 11);
	}
		...
		public ItemCustom() {
			super(new Item.Properties().group(PosionfoodItemGroup.tab).maxStackSize(64).rarity(Rarity.COMMON)
					.food((new Food.Builder()).hunger(2).saturation(1f)
							...
							.build()));
			setRegistryName("poison_mlonslice");
		}
