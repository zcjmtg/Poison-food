...
public class PoisoncakeItem extends PoisonFoodModElements.ModElement {
	@ObjectHolder("poison_food:poisoncake")
	public static final Item block = null;

	public PoisoncakeItem(PoisonFoodModElements instance) {
		super(instance, 2);
	}
