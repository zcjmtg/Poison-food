...
public class PoisonMuttonItem extends PoisonFoodModElements.ModElement {
	@ObjectHolder("poison_food:poison_mutton")
	public static final Item block = null;

	public PoisonMuttonItem(PoisonFoodModElements instance) {
		super(instance, 13);
	}
