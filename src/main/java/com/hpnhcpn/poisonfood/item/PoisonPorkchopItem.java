...
public class PoisonPorkchopItem extends PoisonFoodModElements.ModElement {
	@ObjectHolder("poison_food:poison_porkchop")
	public static final Item block = null;

	public PoisonPorkchopItem(PoisonFoodModElements instance) {
		super(instance, 12);
	}
		...
		public ItemCustom() {
			super(new Item.Properties().group(PosionfoodItemGroup.tab).maxStackSize(64).rarity(Rarity.COMMON)
					.food((new Food.Builder()).hunger(2).saturation(1f)
							...
							.build()));
			setRegistryName("poison_porkchop");
		}
