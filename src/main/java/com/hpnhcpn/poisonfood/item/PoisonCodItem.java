...
public class PoisonCodItem extends PoisonFoodModElements.ModElement {
	@ObjectHolder("poison_food:poison_cod")
	public static final Item block = null;

	public PoisonCodItem(PoisonFoodModElements instance) {
		super(instance, 10);
	}
