...
public class PoisonsweetberriesItem extends PoisonFoodModElements.ModElement {
	@ObjectHolder("poison_food:poisonsweetberries")
	public static final Item block = null;

	public PoisonsweetberriesItem(PoisonFoodModElements instance) {
		super(instance, 3);
	}
		...
		public ItemCustom() {
			super(new Item.Properties().group(PosionfoodItemGroup.tab).maxStackSize(64).rarity(Rarity.COMMON)
					.food((new Food.Builder()).hunger(2).saturation(1f)
							...
							.build()));
			setRegistryName("poisonsweetberries");
		}
