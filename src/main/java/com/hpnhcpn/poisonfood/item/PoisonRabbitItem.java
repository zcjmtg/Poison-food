...
public class PoisonRabbitItem extends PoisonFoodModElements.ModElement {
	@ObjectHolder("poison_food:poison_rabbit")
	public static final Item block = null;

	public PoisonRabbitItem(PoisonFoodModElements instance) {
		super(instance, 14);
	}
