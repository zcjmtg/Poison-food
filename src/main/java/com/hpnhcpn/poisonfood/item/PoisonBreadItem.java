...
public class PoisonBreadItem extends PoisonFoodModElements.ModElement {
	@ObjectHolder("poison_food:poison_bread")
	public static final Item block = null;

	public PoisonBreadItem(PoisonFoodModElements instance) {
		super(instance, 9);
	}
